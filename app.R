...
server <- function(input, output, session) {
  ...
  guidelist <- shiny::reactive(data.table::data.table(
    ...
    intro = c("Select the between-group factor. The list of variables comprises all columns in your dataset.", "Select the number of timepoints, including the baseline.", "Report all the timepoints in the same time unit (e.g., days or months), starting baseline at 0. Use comma separated values (e.g., 0, 3, 12, 48).", "Select the pre-specified type-I error.", "Select the rule for interpreting Cohen's d.", "Edit the group labels. These labels appear in tables and figure, and as options to select the control group below. Use comma separated values.", "Select the control group. If selected, only between-group comparisons envolving the control-group are exhibited.", "Edit the timepoint names. These labels appears in tables and figure. Use comma separated values (e.g., Baseline, 3 weeks, 12 weeks).",
